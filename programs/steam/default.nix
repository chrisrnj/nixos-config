...
let
  ...
  proton-cachyos = inputs.proton-cachyos.packages.${pkgs.stdenv.hostPlatform.system}.proton-cachyos-x86_64_v3;
in
{
  # Steam
  ...
  system.userActivationScripts.steamUsePatchedBwrap.text = lib.mkIf (pkgs.stdenv.hostPlatform.system == "x86_64-linux") ''
  ...
  system.userActivationScripts.protonLink.text = lib.mkIf (pkgs.stdenv.hostPlatform.system == "x86_64-linux") ''
  ...
  # Gamescope
#   programs.gamescope = lib.mkIf (pkgs.stdenv.hostPlatform.system == "x86_64-linux") {
#     enable = true;
#     capSysNice = true;
#   };

  # WiVRn
  services.wivrn = lib.mkIf (pkgs.stdenv.hostPlatform.system == "x86_64-linux") {
    enable = true;
    openFirewall = true;
    autoStart = true;
    highPriority = true;
